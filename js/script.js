...
// Consultation form: send entered details to WhatsApp without external form processing.
...
if (consultationForm) {
  consultationForm.addEventListener('submit', (event) => {
    ...
    const whatsappUrl = `https://wa.me/919148002724?text=${encodeURIComponent(whatsappMessage)}`;
